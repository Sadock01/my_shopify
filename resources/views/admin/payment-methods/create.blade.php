...
<div class="p-6">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Ajouter un Moyen de Paiement - {{ $shop->name }}</h1>
    ...
    <form action="{{ route('admin.shops.payment-methods.store', $shop) }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded-lg p-6">
        @csrf
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                              placeholder="Description détaillée du moyen de paiement...">{{ old('description') }}</textarea>
                </div>
            </div>
            ...
            <div id="bank-transfer-details" class="hidden">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="details[bank_name]" value="{{ old('details.bank_name') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div>
                        ...
                        <input type="text" name="details[account_number]" value="{{ old('details.account_number') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div>
                        ...
                        <input type="text" name="details[swift_code]" value="{{ old('details.swift_code') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div>
                        ...
                        <input type="text" name="details[account_holder]" value="{{ old('details.account_holder') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div id="check-details" class="hidden">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="details[check_recipient]" value="{{ old('details.check_recipient') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                               placeholder="Ex: Jean Dupont">
                    </div>
                    <div>
                        ...
                        <textarea name="details[check_address]" rows="2"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                  placeholder="Adresse pour envoyer le chèque...">{{ old('details.check_address') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div id="mobile-money-details" class="hidden">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="details[mobile_provider]" value="{{ old('details.mobile_provider') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div>
                        ...
                        <input type="text" name="details[mobile_number]" value="{{ old('details.mobile_number') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div id="other-details" class="hidden">
                <div>
                    ...
                    <textarea name="details[custom_details]" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                              placeholder="Détails spécifiques pour ce moyen de paiement...">{{ old('details.custom_details') }}</textarea>
                </div>
            </div>
        </div>
