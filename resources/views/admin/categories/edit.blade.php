...
<div class="p-6">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Modifier la Catégorie - {{ $shop->name }}</h1>
    ...
    <form action="{{ route('admin.shops.categories.update', [$shop, $category]) }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded-lg p-6">
        @csrf
        @method('PUT')
