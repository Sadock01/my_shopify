    ...
    <section class="relative bg-black text-white overflow-hidden">
        @if($shop->banner_image)
            <div class="absolute inset-0">
                <img src="/documents/{{ $shop->banner_image }}" alt="{{ $shop->name }}" class="w-full h-full object-cover">
                ...
                @forelse($featuredProducts as $product)
                    <div class="product-card group bg-white border border-gray-200 hover:border-gray-300 transition-all duration-300 rounded-lg overflow-hidden shadow-sm hover:shadow-md">
                        <div class="relative overflow-hidden">
                            <img src="/documents/{{ $product->image }}" alt="{{ $product->name }}" class="product-image w-full group-hover:scale-105 transition-transform duration-300">
