        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
                ...
                <div class="space-y-4">
                    <!-- Main Image -->
                    <div class="relative">
                        <img id="main-image" src="/documents/{{ $product->image }}" alt="{{ $product->name }}" 
                    ...
                    <div class="flex space-x-4 overflow-x-auto">
                        ...
                        @foreach($product->images as $image)
                            ...
                            <button onclick="changeMainImage('{{ $image }}')" 
                                ...
                                <img src="/documents/{{ $image }}" alt="{{ $product->name }}" class="w-full h-full object-cover">
                            </button>
                            @endif
                        @endforeach
                    </div>
                    ...
                    <div class="border-t border-gray-100 pt-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-sm text-gray-600">Garantie 2 ans</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <svg class="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                ...
                @foreach($relatedProducts as $relatedProduct)
                    <div class="group bg-white border border-gray-100 rounded-2xl overflow-hidden hover-lift">
                        <div class="relative overflow-hidden">
                            <img src="/documents/{{ $relatedProduct->image }}" alt="{{ $relatedProduct->name }}" class="w-full h-80 object-cover group-hover:scale-105 transition-transform duration-700">
